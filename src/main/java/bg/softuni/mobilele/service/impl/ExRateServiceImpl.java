...
import bg.softuni.mobilele.models.dto.ExRatesDTO;
...
import bg.softuni.mobilele.service.ObjectNonFoundException;
...
public class ExRateServiceImpl implements ExRateService {
    ...
    public BigDecimal convert(String from, String to, BigDecimal amount) {
        return findExRate(from, to)
                .orElseThrow(() -> new ObjectNonFoundException("Conversion from " + from + " to " + to + " not possible!"))
                .multiply(amount);
    }
}
